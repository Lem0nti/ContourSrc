...
begin
  abArchContour.Controller(CtrlCode);
end;

function TabArchContour.GetServiceController: TServiceController;
begin
  Result := ServiceController;
end;

procedure TabArchContour.ServiceAfterInstall(Sender: TService);
var
...
procedure TabArchContour.ServiceStart(Sender: TService; var Started: Boolean);
begin
  TStartTH.Create;
end;

procedure TabArchContour.ServiceStop(Sender: TService; var Stopped: Boolean);
begin
  StopAllStarted;
end;
