...
begin
  abRetina.Controller(CtrlCode);
end;

function TabRetina.GetServiceController: TServiceController;
begin
  Result := ServiceController;
end;

procedure TabRetina.ServiceAfterInstall(Sender: TService);
var
...
procedure TabRetina.ServiceStart(Sender: TService; var Started: Boolean);
begin
  TStartTH.Create;
end;

procedure TabRetina.ServiceStop(Sender: TService; var Stopped: Boolean);
begin
  StopAllStarted;
end;
